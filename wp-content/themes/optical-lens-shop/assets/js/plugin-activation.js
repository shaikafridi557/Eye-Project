jQuery(document).ready(function($) {
    'use strict';
    var this_obj = optical_lens_shop_plugin_activate_plugin;

    $('#gutenberg_editor .plugin-activation-redirect a').addClass('ive-redirect-to-dashboard');

    $(document).on('click', '.optical-lens-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message optical-lens-shop-plugin-install');
                button.addClass('button-primary optical-lens-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.optical-lens-shop-recommended-plugins .optical-lens-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.optical-lens-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .optical-lens-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .optical-lens-shop-recommended-plugins').css('display','none');
    });
