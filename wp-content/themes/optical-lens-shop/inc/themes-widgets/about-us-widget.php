...
class Optical_Lens_Shop_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Optical_Lens_Shop_About_Widget',
			__('VW About us', 'optical-lens-shop'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'optical-lens-shop' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','optical-lens-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','optical-lens-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','optical-lens-shop'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','optical-lens-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','optical-lens-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','optical-lens-shop'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function optical_lens_shop_about_custom_load_widget() {
	register_widget( 'Optical_Lens_Shop_About_Widget' );
}
add_action( 'widgets_init', 'optical_lens_shop_about_custom_load_widget' );