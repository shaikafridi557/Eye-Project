...
class UACF7_Admin_Menu {
	...
	public function uacf7_create_admin_page() {
		...
		<div class="wrap uacf7-admin-cont">
			<h1>
				<?php echo esc_html__( 'Ultimate Addons for Contact Form 7 (UACF7) Settings', 'ultimate-addons-cf7' ); ?>
			</h1>
			<p class="sub-head">
				<?php echo esc_html__( 'Tick the addons you need from the below settings Panel and click Save. Those addons will be activated. Then go to the Contact Form 7 settings Panel and start editing.', 'ultimate-addons-cf7' ); ?>
			</p>
			<?php settings_errors(); ?>
			...
			<div class="uacf7-tab">
				<a class="tablinks active" onclick="uacf7_settings_tab(event, 'uacf7_addons')">
					<?php echo esc_html__( 'Addons Settings', 'ultimate-addons-cf7' ); ?>
				</a>

				<?php do_action( 'uacf7_admin_tab_button' ); ?>

				<a class="tablinks" onclick="uacf7_settings_tab(event, 'uacf7_doc')">
	...
	public function uacf7_page_init() {
		...
		add_settings_field(
			'uacf7_web_hook', // id
			__( 'Web hook', 'ultimate-addons-cf7' ), // title
			array( $this, 'uacf7_web_hook_callback' ), // callback
			'ultimate-addons-admin', // page
			'uacf7_setting_section' // section
		);
		...
		add_settings_field(
			...
			array( $this, 'uacf7_enable_form_generator_ai_callback' ), // callback
			'ultimate-addons-admin', // page
			'uacf7_setting_section' // section
		);
		add_settings_field(
	...
	/*
	 * Field - Enable Web Hook
	 * Author : M Hemel Hasn
	 * return string
	 */
	public function uacf7_web_hook_callback() {
		printf(
			'<label class="uacf7-admin-toggle" for="uacf7_web_hook">
				<input type="checkbox" class="uacf7-admin-toggle__input"  name="uacf7_option_name[uacf7_web_hook]" id="uacf7_web_hook" %s>
				<span class="uacf7-admin-toggle-track"><span class="uacf7-admin-toggle-indicator"><span class="checkMark"><svg viewBox="0 0 24 24" id="ghq-svg-check" role="presentation" aria-hidden="true"><path d="M9.86 18a1 1 0 01-.73-.32l-4.86-5.17a1.001 1.001 0 011.46-1.37l4.12 4.39 8.41-9.2a1 1 0 111.48 1.34l-9.14 10a1 1 0 01-.73.33h-.01z"></path></svg></span></span></span>
			</label>', uacf7_checked( 'uacf7_web_hook' )
		);
	}
	 ...
	 * Field - Enable PDF Generator
	 */
	public function uacf7_enable_form_generator_ai_callback() {
		printf(
			'<label class="uacf7-admin-toggle" for="uacf7_enable_form_generator_ai_field">
				<input type="checkbox" class="uacf7-admin-toggle__input" name="uacf7_option_name[uacf7_enable_form_generator_ai_field]" id="uacf7_enable_form_generator_ai_field" %s>
				<span class="uacf7-admin-toggle-track"><span class="uacf7-admin-toggle-indicator"><span class="checkMark"><svg viewBox="0 0 24 24" id="ghq-svg-check" role="presentation" aria-hidden="true"><path d="M9.86 18a1 1 0 01-.73-.32l-4.86-5.17a1.001 1.001 0 011.46-1.37l4.12 4.39 8.41-9.2a1 1 0 111.48 1.34l-9.14 10a1 1 0 01-.73.33h-.01z"></path></svg></span></span></span>
			</label>', uacf7_checked( 'uacf7_enable_form_generator_ai_field' )
		);
	}
